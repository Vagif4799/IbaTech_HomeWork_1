...
/**
 * Here i am going to make a random number game.
 * Game will get predefined random number which the player is not aware.
 * To make it even more interesting i put limit there (just 5 chance).
 */
